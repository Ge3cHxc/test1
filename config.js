...
module.exports = {
    ...
    CAPTION_KEY: process.env.CP === undefined ?'Made By:- ⚜️𝔸𝕝𝕖𝕏𝕒⚜️' : process.env.CP,
    NO_ONLINE: process.env.NO_ONLINE === undefined ? true : convertToBool(process.env.NO_ONLINE),
    SUDO: process.env.SUDO === undefined ? false : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "94768864999-1616997271",
    SUPPORT2:"94768864999-1619710622",
    SUPPORT3:"94768864999-1623132102",
    ...
    G7:"94768864999-1606916704",
    G8:"94768864999-1612721726",
    G9:"94768864999-1623072392",
    G10:"94768864999-1623072431",
    NWS1:"94768864999-1621503960",
    NWS2:"94789375962-1616483925",
    OWN: "94768864999,94770824387,94789375962"
};

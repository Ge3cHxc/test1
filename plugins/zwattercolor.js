...
const lol = "need some word"
    ...
    Asena.addCommand({ pattern: 'wtc ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'wtc ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
